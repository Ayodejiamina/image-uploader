...
function UploadMe() {
  ...
  function handleOverlay() {
    setOverlay((changeOverlay) => !changeOverlay);
  }
    ...
    <>
      <div className={`container`}>
        <div className="subCont">
          ...
          <div className="cont1" style={changeBacgroundCover}>
            <div className="svg1">
              <label htmlFor="cover">
                <svg
            ...
            <div className="svg2">
              <label
                htmlFor="profile"
                onClick={uploadProfile ? handleOverlay : undefined}
              >
                {uploadProfile ? (
                  <img src={uploadProfile} alt="My profile Photo" />
                ) : (
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="1em"
      ...
      <div
        ...
        onClick={overlay ? closeOverlay : handleOverlay}
      >
        <div className="overlay-text animate__animated animate__backInDown">
          <img
            src={uploadProfile as string}
